...
static void test_alpha_display()
{
  ...
  while (1)
  {
    ...
    displaybuffer[0] = alphafonttable[(int)displayStr[0]]; // T.
    displaybuffer[1] = alphafonttable[(int)displayStr[1]]; // D.
    displaybuffer[2] = alphafonttable[(int)displayStr[2]]; // C.
    displaybuffer[3] = alphafonttable[(int)displayStr[3]]; // L.
    // vTaskDelay(100);
    // counter++;
